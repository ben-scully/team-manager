...
class SeriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create series" do
    assert_difference('Series.count') do
      post series_index_url, params: { series: { name: @series.name, squad_id: @series.squad_id } }
    end
  ...
  test "should update series" do
    patch series_url(@series), params: { series: { name: @series.name, squad_id: @series.squad_id } }
